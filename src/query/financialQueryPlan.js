...
function legacyIntentToQueryPlan(intent, parameters = {}) {
    ...
    const map = {
        ...
        ranking_maiores_gastos: { domain: 'expenses', operation: 'rank', filters: categoryFilters, groupBy: ['merchant'], timeBasis: 'billing_month' },
        ...
        ranking_estabelecimentos_gastos: { domain: expenseDomain, operation: 'rank', filters: expenseCategoryFilters, groupBy: ['merchant'], timeBasis: 'billing_month' },
