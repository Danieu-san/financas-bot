...
- Essa fatia cobre o bug da conta de telefone em teste local, mas ainda nao autoriza producao: faltam E2E marker-only, cancelamento/replay idempotente, dry-run/paridade do ledger e decisao GO/NO-GO. `route` deve permanecer desligado fora de teste controlado.
