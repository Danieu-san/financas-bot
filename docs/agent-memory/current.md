...
Criar e publicar o commit sanitizado; executar uma unica auditoria independente
no Chat pelo hash imutavel. Com `GO`, promover por artefato OCI, executar o ciclo
real e confirmar o lote numerado familiar sem escrita financeira automatica.
