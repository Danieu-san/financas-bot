...
| `financial-roadmap-synthesis` | draft v1 criado; revisão adversarial Codex pendente | `financial-roadmap-synthesis.md` | `../../plans/workstreams/financial-roadmap-synthesis.md` | preservar roadmaps/gates/shadows; sem correção ou remoção; usuário confirma antes de canonizar |
