...
| `open-finance-historical-rx` | gate 34 pausado; gate 35 recovery local verde | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | aguarda hash e reauditoria; dados reais e escrita off |
