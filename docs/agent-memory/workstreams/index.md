...
| `financasbot-next-02-n02g` | CHARTER APROVADO; implementação em desenvolvimento | `financasbot-next-02-n02g.md` | `../../plans/workstreams/financasbot-next-02-n02g-v1.md` | admissão/schema/índice iniciais; sem GO parcial; G07/G08/G11/G14 integrais pendentes |
