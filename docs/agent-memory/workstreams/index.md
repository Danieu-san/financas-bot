...
| `open-finance-historical-rx` | gates 31 a 33 com GO tecnico local independente; gate 34 nao iniciado | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | preparar gate 34 separado; sem flag, deploy ou producao sem Daniel presente e autorizacao explicita |
