...
| `chat-codex-channel` | ORCH-02 segundo recovery App-only em validação após NO-GO | `chat-codex-channel.md` | `../../plans/workstreams/chat-codex-channel.md` | somente ponte endurecida; App obrigatório; conclusão pede verificação manual |
