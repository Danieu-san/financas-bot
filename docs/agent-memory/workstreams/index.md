...
| `open-finance-historical-import` | Gate 41.3; catalogo recorrente reconciliado, aguardando auditoria; entradas residuais na fila | `open-finance-historical-import.md` | `../../plans/workstreams/open-finance-historical-import.md` | cruzar RX e planilha; dados privados fora do Git; writer historico desligado |
