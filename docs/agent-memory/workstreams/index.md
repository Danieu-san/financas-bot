...
| `open-finance-historical-rx` | gate 32 fechado; gate 33 recovery local aguardando nova auditoria | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | publicar/reauditar recovery do gate 33; sem flag, deploy ou producao |
