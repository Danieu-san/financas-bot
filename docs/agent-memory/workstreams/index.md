...
| `open-finance-historical-rx` | gates 36-37 GO; gate 38.1 candidato de revalidacao local | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | Gate 38.1 aguarda auditoria; gates 34-35 preservados; escrita off |
