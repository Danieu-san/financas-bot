...
| `financial-conversation-architecture-review` | ARQ-01..06 GO local; artefato off verificado; OCI sem acesso | `financial-conversation-architecture-review.md` | `../../plans/workstreams/financial-conversation-architecture-review.md` | restabelecer SSH normal, fazer preflight e promover off; segredo novo antes do canário; zero writer |
