...
| `open-finance-historical-rx` | previa privada NO_GO; tres blockers | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | poupanca resolvida; parcela, ligacao a posicao e sinal de resgate bloqueiam; nove segmentos e zero escrita |
