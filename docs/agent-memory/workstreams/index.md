...
| `chat-codex-orchestration` | ORCH-01 recovery de idempotência; candidato aguardando reauditoria | `chat-codex-orchestration.md` | `../../plans/workstreams/chat-codex-orchestration.md` | GitHub autoritativo; ponte local sem bot, produção ou dados reais |
