...
| `open-finance-historical-rx` | gates 36-37 GO; gate 38.1 recovery probatorio local | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | Gate 38.1 aguarda reauditoria; gates 34-35 preservados; escrita off |
