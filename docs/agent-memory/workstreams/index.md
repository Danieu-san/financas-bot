...
| `open-finance-historical-import` | Gate 41.4 fechado documentalmente; 113 revisoes preservadas | `open-finance-historical-import.md` | `../../plans/workstreams/open-finance-historical-import.md` | cruzar RX e planilha; dados privados fora do Git; writer historico desligado |
