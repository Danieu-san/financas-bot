...
| `open-finance-historical-rx` | candidato de reserva/lifecycle em validacao | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | contas existentes no corte; cartao Itau entra durante RX; reserva interna e parcela ambigua fail-closed; zero escrita |
