...
| `open-finance-historical-import` | Gate 41 com planejador em GO local; inventario privado read-only em revisao | `open-finance-historical-import.md` | `../../plans/workstreams/open-finance-historical-import.md` | cruzar RX e planilha; dados privados fora do Git; writer historico desligado |
