...
| `open-finance-historical-rx` | gate 34 pausado; gate 35 revisor local candidato | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | suite ampla verde; aguarda hash e auditoria; escrita off |
