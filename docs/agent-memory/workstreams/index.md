...
| `chat-codex-channel` | ORCH-02 campainha state-aware aguardando auditoria | `chat-codex-channel.md` | `../../plans/workstreams/chat-codex-channel.md` | Tarefas de repositório delimitadas; estado ocioso permanece aberto |
