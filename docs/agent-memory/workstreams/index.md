...
| `open-finance-historical-rx` | gate 32 fechado; gate 33 de prontidao de release especificado | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | iniciar RED local do gate 33; sem flag, deploy ou producao |
