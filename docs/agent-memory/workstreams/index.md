...
| `open-finance-historical-rx` | gate 34 pausado; gate 35 PARTIAL_NO_GO; gate 36 recovery local verde | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | Gate 36 aguarda reauditoria; blocker historico preservado; escrita off |
