...
| `financial-conversation-architecture-review` | ARQ-01..06 GO técnico local | `financial-conversation-architecture-review.md` | `../../plans/workstreams/financial-conversation-architecture-review.md` | recovery de entrega reauditado em GO; próximo passo é artefato OCI com canário off; zero writer |
