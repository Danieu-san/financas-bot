...
| `open-finance-historical-rx` | gates 31 a 33 fechados; gate 34 em recovery local de diretorio privado do backup | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | backup real endurecido; candidato aguarda auditoria; nenhum upload/deploy |
