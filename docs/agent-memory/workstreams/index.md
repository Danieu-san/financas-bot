...
| `open-finance-historical-import` | Gate 41 em inventario privado read-only | `open-finance-historical-import.md` | `../../plans/workstreams/open-finance-historical-import.md` | cruzar RX e planilha; dados privados fora do Git; nenhuma escrita antes de auditoria |
