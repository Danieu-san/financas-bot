...
| `open-finance-historical-rx` | GO tecnico local; previa privada read-only autorizada | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | 5 contas + 4 cartoes; subtipos exatos; investimentos separados e cobertura parcial; zero escrita |
