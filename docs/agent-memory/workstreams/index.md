...
| `open-finance-historical-rx` | gate 34 pausado; gate 35 Fase A NO_GO; revisao local em desenho | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | dados privados fora do Chat/Git; equivalencia forte; escrita off |
