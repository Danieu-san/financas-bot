...
| `open-finance-historical-rx` | RX-HIST-SEG-01 recovery local; reauditoria pendente | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | preview local; conta, cartao, fatura e investimento separados; zero escrita |
