...
| `open-finance-historical-rx` | gate 34 promovido na OCI; smoke numerico real pendente | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | release novo saudavel; SSH fechado; escrita off |
