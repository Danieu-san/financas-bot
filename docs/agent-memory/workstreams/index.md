...
| `open-finance-historical-rx` | gate 32 fechado; gate 33 candidato local aguardando auditoria independente | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | publicar/auditar hash do gate 33; sem flag, deploy ou producao |
