...
| `financial-conversation-architecture-review` | ARQ-01 segundo recovery local validado; aguarda commit e reauditoria | `financial-conversation-architecture-review.md` | `../../plans/workstreams/financial-conversation-architecture-review.md` | falha de tool fecha plano; baseline recalculável; zero deploy e writer |
