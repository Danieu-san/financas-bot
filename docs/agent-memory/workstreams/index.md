...
| `financasbot-cp02-inventory` | CANDIDATO DOCUMENTAL; inventário global NEXT-02 para revisão | `financasbot-cp02-inventory.md` | `../../plans/workstreams/financasbot-cp02-closure-inventory-v1.md` | branch própria; três documentos; próximo N02-F proposto |
