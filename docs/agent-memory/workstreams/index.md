...
| `open-finance-historical-rx` | gate 34 pausado; gate 35 GO operacional somente para Fase A | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | executar preflight sem abrir conteudo privado; escrita off |
