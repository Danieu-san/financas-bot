...
| `financial-roadmap-synthesis` | concluído; roadmap v2 canonizado após revisão Codex e confirmação do usuário | `financial-roadmap-synthesis.md` | `../../plans/workstreams/financial-roadmap-synthesis.md` | histórico congelado; execução continua em workstream ROAD-00 separado |
| `financial-roadmap-road00` | ROAD-00 OPEN; 00.1/00.2 inventário estático concluído; 00.3 Golden Set é o próximo gate | `financial-roadmap-road00.md` | `../../plans/workstreams/financial-roadmap-road00.md` | sem correção, deploy, flag, escrita, migração real ou retirada de legado; ROAD-K0 bloqueado até GO |
