...
| `aws-oracle-migration` | não iniciado; reservado para outra conversa | `aws-oracle-migration.md` | `../../plans/workstreams/aws-oracle-migration.md` | não presumir destino remoto nem usar caminhos AWS históricos |
