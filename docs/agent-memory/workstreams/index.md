...
| `financial-conversation-architecture-review` | ARQ-01..05 GO técnico local; ARQ-06 recovery | `financial-conversation-architecture-review.md` | `../../plans/workstreams/financial-conversation-architecture-review.md` | falso promoted corrigido com selected/terminal/pending; próximo passo é reauditoria imutável; zero writer |
