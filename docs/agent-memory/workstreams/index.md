...
| `open-finance-historical-rx` | gate 34 pausado; gate 35 revisor local com GO tecnico | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | proxima Fase A local; dados reais e escrita off |
