...
| `open-finance-historical-rx` | gates 36-38.1 GO local; gate 38.2 a definir | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | Gate 38.1 sem deploy; gates 34-35 preservados; escrita off |
