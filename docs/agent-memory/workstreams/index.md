...
| `open-finance-historical-rx` | gates 31 a 33 fechados; recovery do gate 34 com GO independente | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | novo artefato e prova operacional pendentes; nenhum upload/deploy |
