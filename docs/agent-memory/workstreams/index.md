...
| `financial-roadmap-synthesis` | draft v2 reconciliado após revisão Codex; aguardando confirmação explícita do usuário | `financial-roadmap-synthesis.md` | `../../plans/workstreams/financial-roadmap-synthesis.md` | preservar roadmaps/gates/shadows; sem correção ou remoção; só canonizar após confirmação do usuário |
