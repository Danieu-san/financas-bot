...
| `open-finance-historical-rx` | gate 34 pausado; gate 35 PARTIAL_NO_GO; gates 36-37 GO tecnico local | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | Gate 38 e o proximo; blocker historico preservado; escrita off |
