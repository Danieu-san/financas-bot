...
| `open-finance-historical-rx` | gates 31 a 33 fechados; gate 34 com slot/plano OCI preparados | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | AWS antiga nao confirmada; sem promocao/restart/smoke |
