...
| `open-finance-historical-rx` | gate 31 fechado; gate 32 numerico candidato local | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | auditoria independente obrigatoria; sem flag, deploy ou producao |
