...
| `financial-roadmap-roadk0` | ROAD-K0 GO; contrato semântico v1 congelado sem mudança de runtime | `financial-roadmap-roadk0.md` | `../../plans/workstreams/financial-roadmap-roadk0.md` | IR única, time/evidence/provenance/coverage/double-count congelados; próximo ROAD-01 |
