...
| `financial-conversation-architecture-review` | ARQ-01..06 GO local; canário `off`; recovery 327 em validação local | `financial-conversation-architecture-review.md` | `../../plans/workstreams/financial-conversation-architecture-review.md` | novo smoke somente após GO; modelo público estruturado; zero writer |
