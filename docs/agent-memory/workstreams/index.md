...
| `open-finance-historical-import` | Gate 41; catalogo recorrente em candidato local aguardando auditoria | `open-finance-historical-import.md` | `../../plans/workstreams/open-finance-historical-import.md` | cruzar RX e planilha; dados privados fora do Git; writer historico desligado |
