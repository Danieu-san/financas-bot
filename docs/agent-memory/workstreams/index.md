...
| `open-finance-historical-rx` | RX-HIST-SEG-01 GO tecnico local; preview privado nao autorizado | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | conta, cartao, fatura e investimento separados; zero escrita |
