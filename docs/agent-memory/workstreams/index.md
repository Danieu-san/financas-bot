...
| `financial-roadmap-road00` | ROAD-00 OPEN; baseline/inventário apenas, não executado | `financial-roadmap-road00.md` | `../../plans/workstreams/financial-roadmap-road00.md` | sem correção, deploy, flag, escrita, migração real ou retirada de legado; ROAD-K0 bloqueado até GO |
