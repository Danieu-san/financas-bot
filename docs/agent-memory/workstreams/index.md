...
| `financial-conversation-architecture-review` | ARQ-01 recovery local validado; aguarda commit e reauditoria | `financial-conversation-architecture-review.md` | `../../plans/workstreams/financial-conversation-architecture-review.md` | trajetória/checkpoint; suíte ampla verde; zero flag, deploy e tool de escrita selecionada |
