...
| `financasbot-next-02-n02f` | EM PREPARAÇÃO; contratos e grafos documentais | `financasbot-next-02-n02f.md` | `../../plans/workstreams/financasbot-next-02-n02f-v1.md` | 76/76 e revisão integral antes de compiler/evaluator; sem código funcional |
