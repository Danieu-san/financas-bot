...
| `financial-conversation-architecture-review` | ARQ-01..06 GO local; recovery 327 auditado; deploy com canário `off` pendente | `financial-conversation-architecture-review.md` | `../../plans/workstreams/financial-conversation-architecture-review.md` | uma pergunta base após deploy; follow-up só se promovida; zero writer |
