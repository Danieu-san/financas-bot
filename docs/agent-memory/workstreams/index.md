...
| `open-finance-historical-rx` | recovery de ambiguidade de parcelas em validacao | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | 5 contas + 4 cartoes; subtipos exatos; investimentos e parcelas ambiguas bloqueiam reconciliacao; zero escrita |
