...
| `open-finance-historical-rx` | gate 34 pausado; gate 35 PARTIAL_NO_GO; gate 36 GO tecnico local; gate 37 proximo | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | Gate 37 read-only; blocker historico preservado; escrita off |
