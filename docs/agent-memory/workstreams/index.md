...
| `open-finance-historical-rx` | gates 36-38.1 GO local; gate 38.2 em recovery probatorio | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | Gate 38.2 somente entrada; gates 34-35 preservados; escrita off |
