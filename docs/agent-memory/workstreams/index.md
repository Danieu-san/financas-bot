...
| `financasbot-next-00` | NEXT-00 aberto; NEXT00-02 contratos 1–4 completos; NEXT00-03 pronto | `financasbot-next-00.md` | `../../plans/workstreams/financasbot-next-00.md` | somente contratos e fixtures sanitizadas; zero runtime, produção ou dados reais |
