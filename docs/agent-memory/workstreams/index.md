...
| `open-finance-historical-rx` | gates 31 a 33 fechados; gate 34 revertido com recovery local candidato | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | producao saudavel na release anterior; aguarda auditoria independente |
