...
| `financial-roadmap-synthesis` | CONTROL_ONLY; aguardando auditoria Codex pré-roadmap | `financial-roadmap-synthesis.md` | `../../plans/workstreams/financial-roadmap-synthesis.md` | preservar roadmaps/gates/shadows; draft só após auditoria; sem correção ou remoção de legado |
