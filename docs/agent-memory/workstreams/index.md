...
| `open-finance-historical-rx` | ligacao por posicao com GO tecnico local; leitura live pendente | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | nenhuma leitura real sem autorizacao; parcela e 22 resgates contraditorios seguem bloqueados |
