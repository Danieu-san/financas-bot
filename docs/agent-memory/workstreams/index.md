...
| `open-finance-historical-rx` | recovery do filtro candidato; reauditoria pendente | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | 5 contas + 4 cartoes; subtipos exatos; investimentos separados e cobertura parcial; zero escrita |
