...
| `open-finance-historical-rx` | RX-HIST-TIME-INV-01 candidato local; auditoria pendente | `open-finance-historical-rx.md` | `../../plans/workstreams/open-finance-historical-rx.md` | inicio 2025-07 separado do cutoff de alertas; 4 contas + 4 cartoes; zero escrita |
