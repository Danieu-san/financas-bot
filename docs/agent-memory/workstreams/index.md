...
| `open-finance-historical-import` | Gate 41.5 fechado documentalmente; 105 revisoes preservadas | `open-finance-historical-import.md` | `../../plans/workstreams/open-finance-historical-import.md` | decisoes exatas; dados privados fora do Git; writer historico desligado |
