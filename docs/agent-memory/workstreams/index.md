...
| `financasbot-next-02-n02g` | CORREÇÃO TRACE/TRAVERSAL; reauditoria focal pendente | `financasbot-next-02-n02g.md` | `../../plans/workstreams/financasbot-next-02-n02g-v1.md` | arestas/reads independentes; sem GO parcial; integração e gates integrais pendentes |
