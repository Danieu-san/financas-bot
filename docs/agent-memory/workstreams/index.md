...
| `financial-roadmap-roadk0` | ROAD-K0 OPEN; contrato semântico apenas, não executado | `financial-roadmap-roadk0.md` | `../../plans/workstreams/financial-roadmap-roadk0.md` | sem runtime/produção/writer; congelar contratos existentes antes de ROAD-01..04 |
