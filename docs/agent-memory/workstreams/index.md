...
| `financial-conversation-architecture-review` | ARQ-01..06 GO; canário `expenses` ativo; smoke sintético GO | `financial-conversation-architecture-review.md` | `../../plans/workstreams/financial-conversation-architecture-review.md` | smoke WhatsApp e telemetria terminal pendentes; janela finita; zero writer |
