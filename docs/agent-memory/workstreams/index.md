...
| `financasbot-next-00` | NEXT-00 aberto; NEXT00-01 inventário e taxonomia | `financasbot-next-00.md` | `../../plans/workstreams/financasbot-next-00.md` | somente contratos e fixtures sanitizadas; zero runtime, produção ou dados reais |
