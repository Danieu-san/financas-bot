...
| `financial-roadmap-road00` | ROAD-00 GO; encerrado após revisão independente sem achados | `financial-roadmap-road00.md` | `../../plans/workstreams/financial-roadmap-road00.md` | baseline fechado; nenhuma autorização funcional; próximo gate ROAD-K0 em workstream separado |
