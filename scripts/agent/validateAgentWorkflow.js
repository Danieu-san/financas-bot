...
const checks = [
    ...
    ['docs/agent-memory/START-HERE.md', 12 * 1024, ['resumePortableWork.ps1', 'resume_target', 'matches_current_worktree=true', 'financas_bot_oci_ed25519_20260722', 'financasBot.pem', 'last-safe-handoff.json']],
    ...
    ['scripts/agent/preparePortableHandoff.ps1', 24 * 1024, ['financasbot-safe-handoff-v3', 'canonical_repo_root', 'git_common_dir', 'resume_target', 'content_copied = $false', 'validateAgentWorkflow.js', 'START-HERE.md', 'key_references']],
    ['scripts/agent/resumePortableWork.ps1', 24 * 1024, ['financasbot-portable-resume-v2', 'last-safe-handoff.json', 'canonical_repo_root', 'resume_target', 'matches_current_worktree', 'START-HERE.md', 'key_references', "['content_read'] = $false"]],
