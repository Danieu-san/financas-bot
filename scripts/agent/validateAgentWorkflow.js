...
const checks = [
    ...
    ['scripts/agent/Install-ChatCodexOrchestrationWatcher.ps1', 12 * 1024, ['FinancasBot-ChatCodex-Orchestration', 'IgnoreNew', 'Interactive', 'RunNow', 'app-wake-request']],
    ...
    ['.agents/skills/audit-immutable-gate/SKILL.md', 14 * 1024, ['name: audit-immutable-gate', '## Fontes independentes', '## Auditoria pelo Chat', 'chat-codex-channel.state.json', 'watcher nunca aciona o bot']],
